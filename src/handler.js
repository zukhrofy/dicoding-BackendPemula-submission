...
const getAllBooksHandler = (request, h) => {
  ...
  if (finished) {
    filteredBooks = filteredBooks.filter((item) => item.finished === Boolean(Number(finished)));
  }
  if (reading) {
    filteredBooks = filteredBooks.filter((item) => item.reading === Boolean(Number(reading)));
  }
